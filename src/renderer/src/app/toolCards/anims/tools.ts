...
//
// Replace `Placeholder` with a real animation one card at a time; AUTHORING.md has the pattern.
...
export const TOOL_GROUP: Record<Extract<ToolCardKey, `tool:${string}`>, ToolCardDef> = {
  ...
  'tool:triangle': { title: 'Triangle', shortcut: 'T', sentence: 'Click the three corners.', Animation: Placeholder },
  'tool:polygon': { title: 'Polygon', shortcut: 'G', sentence: 'Click each corner in turn, then click the first corner again to finish.', Animation: Placeholder },
  'tool:angle': { title: 'Angle', shortcut: 'A', sentence: 'Click a point on one arm, the vertex, then a point on the other arm.', Animation: Placeholder },
  'tool:distance': { title: 'Measure', shortcut: 'D', sentence: 'Click two points to measure the distance between them.', Animation: Placeholder },
  'tool:midpoint': { title: 'Midpoint', shortcut: 'M', sentence: 'Click two points, or a segment, to mark the point halfway between.', Animation: Placeholder },
  'tool:perpendicular': { title: 'Perpendicular', sentence: 'Click a point and a line, in either order, for the line through the point at right angles.', Animation: Placeholder },
  'tool:parallel': { title: 'Parallel', sentence: 'Click a point and a line, in either order, for the line through the point that never meets it.', Animation: Placeholder },
  'tool:perpBisector': { title: 'Perp. bisector', sentence: 'Click two points, or a segment, for the line that cuts it in half at right angles.', Animation: Placeholder },
