...
export function Delete() {
  return (
    <Scene>
      {/* The object as it stood before the click. It vanishes at the click: left in place under
          the outline it read as selected, not deleted, on the still frame. */}
      <circle className="tc-vanish" cx={AT[0]} cy={AT[1]} r="10" fill="var(--text-dim)" />
      <Click at={AT} />
