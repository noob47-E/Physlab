// Scientific constants (CODATA 2022 — the 2022 adjustment, published as NIST SP 959, May 2024;
// https://physics.nist.gov/cuu/Constants/Table/allascii.txt), numbered like the fx-991EX CONST
// list, plus extras. Constants fixed by the 2019 SI redefinition (h, e, k_B, N_A, c, and anything
// built only from them: F, R, sigma_SB, c_1, c_2, phi_0, G_0, R_K, K_J, g_n, atm_std, t_C) do not
// move between adjustments and are unchanged from CODATA 2018. Measured constants shifted in
// 2022 — most from the electron and proton mass measurements — see PROGRESS.md / the 0.9-GATE
// commit for the full list of what changed from 2018 and by how much.
...
export const CONSTANTS: PhysConst[] = [
  { no: 1, symbol: 'mₚ', id: 'm_p', name: 'proton mass', value: 1.67262192595e-27, unit: 'kg' },
  { no: 2, symbol: 'mₙ', id: 'm_n', name: 'neutron mass', value: 1.67492750056e-27, unit: 'kg' },
  { no: 3, symbol: 'mₑ', id: 'm_e', name: 'electron mass', value: 9.1093837139e-31, unit: 'kg' },
  { no: 4, symbol: 'mμ', id: 'm_mu', name: 'muon mass', value: 1.883531627e-28, unit: 'kg' },
  { no: 5, symbol: 'a₀', id: 'a_0', name: 'Bohr radius', value: 5.29177210544e-11, unit: 'm' },
  { no: 6, symbol: 'h', id: 'h_P', name: 'Planck constant', value: 6.62607015e-34, unit: 'J s' },
  { no: 7, symbol: 'μN', id: 'mu_N', name: 'nuclear magneton', value: 5.0507837393e-27, unit: 'J/T' },
  { no: 8, symbol: 'μB', id: 'mu_B', name: 'Bohr magneton', value: 9.2740100657e-24, unit: 'J/T' },
  { no: 9, symbol: 'ħ', id: 'hbar', name: 'reduced Planck constant', value: 1.054571817e-34, unit: 'J s' },
  { no: 10, symbol: 'α', id: 'alpha_f', name: 'fine-structure constant', value: 7.2973525643e-3, unit: '' },
  { no: 11, symbol: 'rₑ', id: 'r_e', name: 'classical electron radius', value: 2.8179403205e-15, unit: 'm' },
  { no: 12, symbol: 'λc', id: 'lambda_c', name: 'Compton wavelength', value: 2.42631023538e-12, unit: 'm' },
  { no: 13, symbol: 'γₚ', id: 'gamma_p', name: 'proton gyromagnetic ratio', value: 2.6752218708e8, unit: '1/(s T)' },
  { no: 14, symbol: 'λcp', id: 'lambda_cp', name: 'proton Compton wavelength', value: 1.32140985360e-15, unit: 'm' },
  { no: 15, symbol: 'λcn', id: 'lambda_cn', name: 'neutron Compton wavelength', value: 1.31959090382e-15, unit: 'm' },
  { no: 16, symbol: 'R∞', id: 'R_inf', name: 'Rydberg constant', value: 10973731.568157, unit: '1/m' },
  { no: 17, symbol: 'u', id: 'u_amu', name: 'atomic mass unit', value: 1.66053906892e-27, unit: 'kg' },
  { no: 18, symbol: 'μₚ', id: 'mu_p', name: 'proton magnetic moment', value: 1.41060679545e-26, unit: 'J/T' },
  { no: 19, symbol: 'μₑ', id: 'mu_e', name: 'electron magnetic moment', value: -9.2847646917e-24, unit: 'J/T' },
  { no: 20, symbol: 'μₙ', id: 'mu_n', name: 'neutron magnetic moment', value: -9.6623653e-27, unit: 'J/T' },
  ...
  { no: 32, symbol: 'ε₀', id: 'eps_0', name: 'electric constant (permittivity)', value: 8.8541878188e-12, unit: 'F/m' },
  { no: 33, symbol: 'μ₀', id: 'mu_0', name: 'magnetic constant (permeability)', value: 1.25663706127e-6, unit: 'N/A²' },
  ...
  { no: 37, symbol: 'Z₀', id: 'Z_0', name: 'characteristic impedance of vacuum', value: 376.730313412, unit: 'Ω' },
  ...
  { no: 46, symbol: 'k₀', id: 'k_e', name: 'Coulomb constant 1/(4πε₀)', value: 8.9875517862e9, unit: 'N m²/C²' },
