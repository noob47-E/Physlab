...
export const MATERIALS: Material[] = [
  { id: 'steel', label: 'Steel', density: 7850, friction: 0.6, restitution: 0.6, color: '#adb5bd' },
  { id: 'aluminium', label: 'Aluminium', density: 2700, friction: 0.5, restitution: 0.5, color: '#ced4da' },
  { id: 'wood', label: 'Wood', density: 700, friction: 0.5, restitution: 0.4, color: '#c98a45' },
  { id: 'rubber', label: 'Rubber', density: 1200, friction: 1.0, restitution: 0.85, color: '#495057' },
  { id: 'glass', label: 'Glass', density: 2500, friction: 0.4, restitution: 0.55, color: '#74c0fc' },
  { id: 'concrete', label: 'Concrete', density: 2400, friction: 0.8, restitution: 0.2, color: '#868e96' },
  { id: 'ice', label: 'Ice', density: 917, friction: 0.05, restitution: 0.1, color: '#a5d8ff' },
  { id: 'plastic', label: 'Plastic', density: 950, friction: 0.35, restitution: 0.6, color: '#ffd43b' },
  { id: 'cork', label: 'Cork', density: 240, friction: 0.6, restitution: 0.3, color: '#e8c39e' },
  { id: 'lead', label: 'Lead', density: 11340, friction: 0.5, restitution: 0.2, color: '#5c6670' },
  { id: 'foam', label: 'Foam', density: 60, friction: 0.7, restitution: 0.15, color: '#ffa8a8' }
]
